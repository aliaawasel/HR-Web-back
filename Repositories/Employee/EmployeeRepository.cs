...
namespace HR_System.Repositories.Employee
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public EmployeeDto GetEmpById(int id)
        {
            ...
            EmpDTO.BirthDate = Employee.BirthDate;
            EmpDTO.HireDate = Employee.HireDate;
            EmpDTO.Address = Employee.Address;
            EmpDTO.Gender = Employee.Gender;

            return (EmpDTO);
        }
        public void Insert(EmployeeDto NewEmpDto)
        {
        ...
        public void Update( EmployeeDto UpdateEmpDto)
        {
            var NewEmp = new Models.Employee
            {
                ID = UpdateEmpDto.ID,
